	...
	public static void Ai2Fun() {
...

		{
			...
			while (playerposition<=100&&ai1pos<=100&&ai2pos<=100)
			{
				...
				{
					System.out.println("Your role was "+movep+"and the rolls of the first second and third Ai in their respective order."+moveai1+","+moveai2+".");
					playerposition=playerposition-20;
					System.out.println("Your position is 79.");
				}
				else if (playerposition==snake1||ai1pos==snake1||ai2pos==snake1)
				{
					System.out.println("Your role was "+movep+"and the rolls of the first second and third Ai in their respective order."+moveai1+","+moveai2+".");
					playerposition=playerposition-20;
				...
				else if (playerposition==snake2||ai1pos==snake2||ai2pos==snake2)
				{
					System.out.println("Your role was "+movep+"and the rolls of the first second and third Ai in their respective order."+moveai1+","+moveai2+".");
					playerposition=playerposition-20;
					if (playerposition<1){
				...
				else if (playerposition==ladder1||ai1pos==ladder1||ai2pos==ladder1)
				{
					System.out.println("Your role was "+movep+"and the rolls of the first second and third Ai in their respective order."+moveai1+","+moveai2+".");
					playerposition=playerposition+20;
					System.out.println("Your position is "+playerposition+".");
				}
				else if (playerposition==ladder2||ai1pos==ladder2||ai2pos==ladder2)
				{
					System.out.println("Your role was "+movep+"and the rolls of the first second and third Ai in their respective order."+moveai1+","+moveai2+".");
					playerposition=playerposition+20;
					System.out.println("Your position is "+playerposition+".");
				}
				else if (playerposition==ladder3||ai1pos==ladder3||ai2pos==ladder3)
				{
					System.out.println("Your role was "+movep+"and the rolls of the first second and third Ai in their respective order "+moveai1+","+moveai2+".");
					playerposition=playerposition+20;
					System.out.println("Your position is "+playerposition+".");
